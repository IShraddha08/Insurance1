...
public class FetchCustomers extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<InsuranceDetails> li=(ArrayList<InsuranceDetails>)obj;
		...
		out.print("<tr><td>"+cmr.getVregno()+" </td><td>"+cmr.getVmake()+"</td><td>"+cmr.getVmodel()+" </td><td>"+cmr.getVcc()+"</td><td align=\"center\">"+cmr.getFueltype() +"</td><td>"+cmr.getChassisno()+"</td>"
					...
					+ "<td align=\"center\">"+cmr.getPincode()+"</td><td align=\"center\">"+cmr.getMobileno() +"</td><td>"+cmr.getEmailid()+" </td><br><br><br>");
	    out.print("</table>");
		}
