...
import java.sql.SQLException;
    ...
    public int insertInsuranceDetails(InsuranceDetails s) {
    	...
    	preparedstatement.setDate(12, (Date)s.getStartdate());
    	preparedstatement.setDate(13, (Date)s.getExpirydate()); 
    	preparedstatement.setDouble(14,s.getIdvalue());
    	preparedstatement.setDouble(15,s.getPacover());
    	preparedstatement.setInt(16,s.getNpassenger());
